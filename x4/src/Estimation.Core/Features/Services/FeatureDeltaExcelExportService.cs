...
public static class FeatureDeltaExcelExportService
{
    ...
    /// <summary>An additional per-row column appended after the comparable fields (used by HashApprovals).</summary>
    public record ExtraColumn(string Header, double Width, Func<FeatureDeltaRow, string?> Value);
    ...
    public static byte[] Build(
        ...
        string labelA,
        string labelB,
        IReadOnlyList<ExtraColumn>? extraColumns = null)
    {
        ...
        {
            headers.Add(extra.Header);
            widths.Add(extra.Width);
        }
