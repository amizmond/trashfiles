...
using Estimation.Core.HashApprovals.Data; // HashApprovals
using Estimation.Core.JiraIntegration.Client;
using Estimation.Core.JiraIntegration.Models;
using Estimation.Core.PlanningIncrement.Models;
using Estimation.Core.ReviewRounds.Data; // ReviewRounds
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<AppPage>(e =>
        {
            ...
            e.HasData(
                ...
                new AppPage { Id = 26, Key = "Risks", DisplayName = "Risk Register", Group = null, IsAdminOnly = false, SortOrder = 102, ScopeMode = PageScopeMode.GeneralOnly },
        ...
        modelBuilder.ApplyReviewRounds(); // ReviewRounds: remove together with the ReviewRounds folder (then add a migration dropping its tables)
        modelBuilder.ApplyHashApprovals(); // HashApprovals: remove together with the HashApprovals folder (then add a migration dropping its table)
        ...
        modelBuilder.Entity<Risk>(e =>
        {
            ...
            // Raised and due are calendar dates, so they carry no time component.
            ...
            // The view always reads one PI at a time, oldest first.
        ...
        modelBuilder.Entity<RiskCapitalProject>(e =>
        {
            ...
            // Retiring an ART only drops the link; the risk and its history stay.
