...
using Estimation.Core.HashApprovals; // HashApprovals
using Estimation.Core.ReviewRounds; // ReviewRounds
...
public class Program
{
    ...
    public static async Task Main(string[] args)
    {
        ...
        try
        {
            ...
            // Two approval options are under evaluation; both are on unless switched off in appsettings
            // ("Approvals": { "ReviewRounds": false }). See ReviewRounds/README.md and HashApprovals/README.md.
            if (builder.Configuration.GetValue("Approvals:ReviewRounds", true))
            {
                builder.Services.AddReviewRounds(); // ReviewRounds: remove together with the ReviewRounds folders
            }

            if (builder.Configuration.GetValue("Approvals:HashApprovals", true))
            {
                builder.Services.AddHashApprovals(); // HashApprovals: remove together with the HashApprovals folders
            }
