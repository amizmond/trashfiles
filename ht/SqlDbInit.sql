...
CREATE NONCLUSTERED INDEX [IX_StrategicObjectives_Summary] ON [dbo].[StrategicObjectives] ([Summary]);
...
CREATE NONCLUSTERED INDEX [IX_PortfolioEpics_Summary] ON [dbo].[PortfolioEpics] ([Summary]);
...
CREATE NONCLUSTERED INDEX [IX_BusinessOutcomes_Summary]          ON [dbo].[BusinessOutcomes] ([Summary]);
