...
public class EstimationDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<StrategicObjective>(e =>
        {
            ...
            e.HasKey(pp => pp.Id);
            e.Property(pp => pp.Summary).IsRequired().HasMaxLength(100);
            e.Property(pp => pp.JiraId).HasMaxLength(100);
            e.Property(pp => pp.Description).HasMaxLength(32767);
        ...
        modelBuilder.Entity<PortfolioEpic>(e =>
        {
            ...
            e.Property(pe => pe.Summary).HasMaxLength(100);
            e.Property(pe => pe.Description).HasMaxLength(32767);
        ...
        modelBuilder.Entity<BusinessOutcome>(e =>
        {
            ...
            e.Property(bo => bo.Summary).HasMaxLength(100);
            e.Property(bo => bo.Description).HasMaxLength(32767);
