...
public class EstimationDbContext : DbContext
{
    ...
    public DbSet<FeatureChangeReview> FeatureChangeReviews => Set<FeatureChangeReview>();
    public DbSet<FeatureChangeReviewItem> FeatureChangeReviewItems => Set<FeatureChangeReviewItem>();
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<FeatureChangeReview>(e =>
        {
            ...
            // not disappear underneath a review. FeatureSnapshotService.DeleteAsync refuses to
