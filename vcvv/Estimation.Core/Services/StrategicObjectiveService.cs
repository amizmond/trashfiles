...
public record JiraSyncItem(string JiraKey, string? Name, string? Description, string? IssueType, string? Labels, string? Status, DateTime? JiraUpdated, DateTime? TargetStart, DateTime? TargetEnd, int? StoryPoints)
{
    /// <summary>
