...
public interface IDashboardService
{
    ...
    Task<List<CapitalProjectOption>> GetCapitalProjectOptionsAsync(
        IReadOnlyCollection<int>? allowedCapitalProjectIds,
        CancellationToken ct = default);

    Task<List<PiTimelineItem>> GetPiTimelineAsync(CancellationToken ct = default);

    Task<List<CapitalProjectOption>> GetArtSprintOptionsAsync(
        IReadOnlyCollection<int>? allowedCapitalProjectIds,
        CancellationToken ct = default);
...
public class DashboardService : IDashboardService
{
    ...
    public Task<List<CapitalProjectOption>> GetCapitalProjectOptionsAsync(
        IReadOnlyCollection<int>? allowedCapitalProjectIds,
        CancellationToken ct = default)
    {
    ...
    private static async Task<List<CapitalProjectOption>> LoadCapitalProjectOptionsAsync(
    ...
    public Task<List<CapitalProjectOption>> GetArtSprintOptionsAsync(
        IReadOnlyCollection<int>? allowedCapitalProjectIds,
        CancellationToken ct = default)
    {
        return GetCachedAsync(
    ...
    private static async Task<List<CapitalProjectOption>> LoadArtSprintOptionsAsync(
        EstimationDbContext db, IReadOnlyCollection<int>? allowedCapitalProjectIds, CancellationToken ct)
    {
