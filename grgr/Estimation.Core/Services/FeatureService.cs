...
public class FeatureService : IFeatureService
{
        ...
        int page, int pageSize, string? search = null)
    {
        ...
        if (!string.IsNullOrWhiteSpace(search))
        {
            ...
            query = query.Where(f =>
                ...
                (f.BusinessOutcome != null && f.BusinessOutcome.Name != null && f.BusinessOutcome.Name.Contains(term)));
        }
        ...
        int page, int pageSize, string? search, string? sortField, bool sortAsc, CancellationToken ct = default)
    {
        ...
        var sorted = sortField?.ToLowerInvariant() switch
        {
            ...
            "businessoutcome" => sortAsc ? baseQuery.OrderBy(f => f.BusinessOutcome!.Name) : baseQuery.OrderByDescending(f => f.BusinessOutcome!.Name),
        ...
        var projected = await sorted
            ...
            .Select(f => new
            {
                ...
                BusinessOutcomeName = f.BusinessOutcome != null ? f.BusinessOutcome.Name : null,
