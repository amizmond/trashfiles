...
public class ArtSprintTimelineTests
{
    ...
    private static ArtSprint ArtSprint(int id, int artId, string name, int startOffset, int endOffset) => new()
    {
        Id = id,
    ...
    private Task SeedAsync() => _db.SeedAsync(db =>
    {
        ...
        db.CapitalProjects.Add(new Art { Id = 1, Name = "Borealis" });
        db.CapitalProjects.Add(new Art { Id = 2, Name = "Atlas" });
        db.CapitalProjects.Add(new Art { Id = 3, Name = "No sprints yet" });
