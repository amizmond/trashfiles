...
public class ArtServiceTeamLinkTests
{
    ...
    private Task SeedAsync() => _db.SeedAsync(db =>
    {
        ...
        db.CapitalProjects.Add(new Art { Id = 2, Name = "Borealis" });
    ...
    public async Task Removing_a_team_unlinks_its_art_sprints_but_keeps_them()
    {
        await SeedAsync();
        await _service.AddTeamAsync(1, 10);
        await _artSprints.SaveAsync(new ArtSprint
        {
            CapitalProjectId = 1,
            PiId = 7,
            Name = "186",
