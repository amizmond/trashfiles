...
public abstract class FeatureHygieneScopedPageBase : ComponentBase
{
    ...
    [Inject] protected IArtService CapitalProjects { get; set; } = null!;
    ...
    protected List<Art> Arts { get; private set; } = new();
    ...
    protected Art? SelectedArt => Arts.FirstOrDefault(a => a.Id == ArtId);
