...
public class Program
{
    ...
    public static async Task Main(string[] args)
    {
        ...
        try
        {
            ...
            builder.Services.AddScoped<IArtSprintService, ArtSprintService>();
            ...
            builder.Services.AddScoped<IGlobalMessageService, GlobalMessageService>();
            builder.Services.AddSingleton<IGlobalMessageNotifier, GlobalMessageNotifier>();
            ...
            builder.Services.AddScoped<IJiraLabelsRefreshService, JiraLabelsRefreshService>();
            builder.Services.AddHostedService<JiraLabelsRefreshBackgroundService>();
